...
export declare function item_edit_arrayed_actions(path: string, title: string, helper: HelperOptions): string;
/**
 ...
 */
export declare function item_edit_arrayed_damage(path: string, title: string, helper: HelperOptions): string;
/**
 ...
 */
export declare function item_edit_arrayed_range(path: string, title: string, helper: HelperOptions): string;
/**
 ...
 */
export declare function item_edit_arrayed_bonuses(path: string, helper: HelperOptions): string;
 ...
 */
export declare function item_edit_arrayed_deployables(path: string, title: string, helper: HelperOptions): string;
/**
 ...
 */
export declare function item_edit_arrayed_synergies(path: string, title: string, helper: HelperOptions): string;
/**
 ...
 */
export declare function item_edit_arrayed_enum(title: string, path: string, enum_name: string, helper: HelperOptions): string;
export declare function item_edit_enum(path: string, enum_name: string, helper: HelperOptions): string;
/**
 ...
 */
export declare function item_edit_effect(path: string, helper: HelperOptions): string;
/**
 ...
 */
export declare function item_edit_arrayed_integrated(path: string, title: string, helper: HelperOptions): string;
/**
 ...
 */
export declare function item_edit_license(helper: HelperOptions): string;
/**
 ...
 */
export declare function item_edit_sp(path: string, helper: HelperOptions): string;
/**
 ...
 */
export declare function item_edit_uses(cur_uses_path: string, max_uses_path: string, helper: HelperOptions): string;
