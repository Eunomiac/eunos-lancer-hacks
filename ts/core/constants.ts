...
import {LancerActorType} from "../@types/module/actor/lancer-actor";
...
const getBondQuestions = (bQuestion: string) => ({
...
const C: {
  ...
  bondPowers: Record<LancerBondType, LancerBondPowerData[]>,
  bondPowersMap: Record<string, LancerBondType>,
  bondBoons: Record<LancerBondType, LancerBondPowerData>,
  bondMajorIdeals: Record<LancerBondType, Record<"a"|"b"|"c", string>>,
  bondMinorIdeals: Record<LancerBondType, string[]>,
  bondQuestions: Record<LancerBondType, Record<"a"|"b", {question: string, answer?: string}>>,
  clockColors: string[],
  randomColor: string,
  barBrawlConfigs: Record<
    string,
    BB_Config | Record<string, never> | Record<
      LancerActorType,
      BB_Config|Record<string, never>
    >
  >
} = {
  bondTypes: {
